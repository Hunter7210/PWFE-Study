...
function TodoList() {
    ...
    return (
        ...
        <div>
            ...
            />
            {/* Renderiza um campo de entrada de texto onde o usuário pode digitar uma nova tarefa. O valor do campo é definido como 'newTask', e o 'onChange' atualiza o valor de 'newTask' com o que o usuário digitar. */}
